...
parser.add_argument(
    ...
    "--img_path",
    type=str,
    default="data/MedSAMDemo_2D/train/images", # The path of your input dataset's images
...
parser.add_argument(
    ...
    "--gt_path",
    type=str,
    default="data/MedSAMDemo_2D/train/labels", # The path of your input dataset's masks
...
parser.add_argument(
    ...
    "--npz_path",
    type=str,
    default="data/demo2D",  # The path to save your output data
