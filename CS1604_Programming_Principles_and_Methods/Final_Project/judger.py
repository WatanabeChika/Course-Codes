...
TASKS = [
    ('1_task1', ['actions.cpp','algorithms.cpp','engine.cpp','field.cpp','units.cpp','main.cpp']),
    ('2_task2', ['actions.cpp','algorithms.cpp','engine.cpp','field.cpp','units.cpp','main.cpp']),
    ('3_task3', ['actions.cpp','algorithms.cpp','engine.cpp','field.cpp','units.cpp','main.cpp']),
]
...
def compile_and_link(args, task, workdir):
    ...
    try:
        for src_path, obj_path in zip(src_paths, obj_paths):
            subprocess.run(
                ['g++', '-Wall','-Wextra', '-pedantic', '-std=c++11'] + args.cs1604_cxxargs
